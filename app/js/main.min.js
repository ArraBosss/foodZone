      ...
      <li class="popular__item">
                <article class="product-card">
                  ...
                  <div class="product-card__row">
                    <span class="product-card__price">${s}
                      <span class="product-card__currency">грн.</span>
                    </span>

                    <span class="product-card__weight">${i}
                      <span>${r}</span>
                    </span>
                  </div>
...
`;productsBlock.innerHTML=e})}}const productPage=new Products;productPage.render(),document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".burger"),t=document.querySelector(".menu"),a=document.querySelector("body"),s=document.querySelector(".overlay");e.addEventListener("click",()=>{t.classList.toggle("menu--active"),t.classList.contains("menu--active")?(e.classList.add("burger--active"),a.classList.add("lock"),s.classList.add("overlay--active")):(e.classList.remove("burger--active"),a.classList.remove("lock"),s.classList.remove("overlay--active"))})});